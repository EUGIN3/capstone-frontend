...
//     return appointment.find(a => a.id === appointmentId) || null;
//   };
    ...
    <div className="IndividualProject">
      {project && project.length > 0 ? (
        project.map((item, index) => {
          ...
          return (
            <div className={`indi-container-main ${item.process_status === 'done' && 'done'}`} key={index}>
                  ...
                  <Tooltip title="View" arrow>
                    <div className="indi-image-container">
                      <img
                        ...
                        alt={item.attire_type}
                        onClick={() => handleImageClickApp(appointmentImage || noImage)}
                      />
                    </div>
                  </Tooltip>
